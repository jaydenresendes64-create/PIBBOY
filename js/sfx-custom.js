...
(function(ST){
  ...
  var LABELS = {
    ...
    step:'Skill + / −', mapSelect:'Map: select a place', geiger:'Rads (Geiger counter)', radaway:'Backup made (RadAway)', key:'RobCo boot: typing', ping:'Scanner: blip', perk:'Perk acquired', bobble:'Bobblehead found'
  };
